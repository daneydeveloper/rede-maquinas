            ...
            <div class="container">
               <div class="logo">
                  <a href="<?= base_url('home');?>">
                  	<img src="<?=THEME_PATH?>/images/logo.png" alt="Rede Máquinas" class="img-responsive"/>
                  </a>
               </div>
                  ...
                  <div class="widget  widget-icon-box">
                     <div class="icon-box">
                        ...
                        <div class="icon-box__text">
                           ...
                           <span class="icon-box__subtitle">contato@redemaquinas.com.br</span>
                        </div>
                     </div>
                  </div>
                  <div class="widget  widget-icon-box">
                     <div class="icon-box">
                        ...
                        <div class="icon-box__text">
                           ...
                           <span class="icon-box__subtitle">Seg - Sex : 07:30 - 17:30</span>
                        </div>
                     </div>
                  </div>
               ...
               <div class="navigation">
                  <div class="collapse  navbar-collapse" id="buildpress-navbar-collapse">
                     <ul id="menu-main-menu" class="navigation--main">
                        <li class="current-menu-item"><a href="<?= base_url('home')?>">INÍCIO</a></li>
                        ...
                        <li class="menu-item-has-children">
									<a>SERVIÇOS</a>
									<ul class="sub-menu">
										<li><a href="<?= base_url('segunda-via-boleto')?>">2ª Via de Boleto</a></li>
										<li><a href="<?= base_url('segunda-via-contrato')?>">2ª Via de Contrato</a></li>
									</ul>
								</li>
