...
<div class="page-content" ng-controller="EditarProdutos">
  <editar ng-init="getProdutos(<?=$this->uri->segment(4)?>)"></editar>
          ...
          <section class="card">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <fieldset class="form-group">
                      ...
                      <select class="form-control" ng-model="produto.PRO_CodigoCategoria">
            ...
            <footer>
              <div class="form-group text-right">
                ...
                <button type="button" class="btn btn-inline btn-success" ng-disabled="formUsuario.$invalid" ng-click="atualizarProduto(produto)">Atualizar e Continuar para Galeria</button>
              </div>
            </footer>
          </section>
        </div><!--.col- -->
