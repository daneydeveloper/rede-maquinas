...
<div class="page-content" ng-controller="editarPagina">
    <fon ng-init="getPagina('<?=$id_page?>')"></fon>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-5" ng-if="pagina.PAG_Tipo == 2">
                    <fieldset class="form-group">
                      ...
                      <input type="text" class="form-control maxlength" ng-model="pagina.PAG_Title" ng-required="true" maxlength="60">
                  ...
                  <div class="col-lg-3" ng-if="pagina.PAG_Tipo == 2">
                    <fieldset class="form-group">
                      ...
                      <input type="text" class="form-control maxlength" ng-model="pagina.PAG_SEODescription" maxlength="160" ng-required="true">
