                  ...
                  <div class="row">
                     ...
                     <div class="col-xs-12  col-sm-8">
                        <span class="wpcf7-form-control-wrap your-message">
                        	<textarea ng-model="dados.tmp.mensagem" ng-required="true" ng-disabled="load" name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" placeholder="Observações*" style="height: 314px;"></textarea>
                        </span><br/>
