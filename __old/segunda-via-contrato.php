   ...
   <body>
      <div class="boxed-container">
         ...
         <div class="main-title" style="background-color: #f2f2f2">
            <div class="container">
               <h1 class="main-title__primary">Segunda Via do Contrato</h1>
                           ...
                           <div class="row">
                              ...
                              <div class="col-xs-12  col-sm-8">
                                 <span class="wpcf7-form-control-wrap your-message">
                                 	<textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" placeholder="Observações"></textarea>
                                 </span><br/>
