...
<html lang="pt-BR">
   <head>
      ...
      <title>Rede Máquinas | Locação de Máquinas e Equipamentos para Construção</title>
                           ...
                           <div class="row">
                              <div class="col-xs-12  col-sm-4">
                                 <span class="wpcf7-form-control-wrap your-name">
                                 	<input type="text" size="40" class="wpcf7-form-control wpcf7-text" placeholder="Nome Completo"/>
                                 </span><br/>
                                 <span class="wpcf7-form-control-wrap your-email">
                                 	<input type="email" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email" placeholder="E-mail"/>
                                 </span><br/>
                                 <span class="wpcf7-form-control-wrap your-subject">
                                 	<input size="40" class="wpcf7-form-control wpcf7-text" placeholder="Telefone"/>
                                 </span>
                                 <span class="wpcf7-form-control-wrap your-subject">
                                 	<input type="text" size="40" class="wpcf7-form-control wpcf7-text" placeholder="Empresa"/>
                                 </span>
                                 <span class="wpcf7-form-control-wrap your-subject">
                                 	<input type="text" size="40" class="wpcf7-form-control wpcf7-text" placeholder="Referência do Boleto"/>
                                 </span>
                              </div>
                              <div class="col-xs-12  col-sm-8">
                                 <span class="wpcf7-form-control-wrap your-message">
                                 	<textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" placeholder="Observações" style="height: 315px;"></textarea>
                                 </span><br/>
